...
/*Callback to output final recognition result.This function will be called just after recognition of an input ends*/
static void output_result(Recog *recog, void *dummy){
	...
	HMM_Logical *p;
	SentenceAlign *align;
	/*all recognition results are stored at each recognition processinstance*/
...
int main(int argc, char *argv[]){
	...
	/*calling j_close_stream(recog) at any time will terminate recognition and exit 
	j_recognize_stream()*/
